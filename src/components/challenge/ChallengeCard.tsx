    ...
    <div className="flex items-start justify-between gap-4">
      <div className="flex-1">
        ...
        <div className="mb-3 flex items-center gap-3 text-sm">
          ...
          {typeof challenge.maxScore === 'number' && (
      ...
      <div className="ml-2 flex items-center gap-3">
        ...
        {challenge.isSolve ? (
          <button
            className="inline-flex h-[36px] w-[150px] items-center justify-center rounded border border-gray-700 bg-transparent text-[14px] font-medium text-gray-200 transition-colors hover:border-transparent hover:bg-gray-800 disabled:cursor-default disabled:opacity-90"
            disabled
          >
            Solved
          ...
          <button className="inline-flex h-[36px] w-[150px] items-center justify-center rounded border border-gray-700 bg-green-500 text-[14px] font-medium text-black transition-colors hover:border-transparent hover:bg-green-300">
            Solve Challenge
          </button>
        )}
      </div>
